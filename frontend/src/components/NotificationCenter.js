...
export default function NotificationCenter({ API }) {
  ...
  const iconForType = (type) => {
    switch (type) {
      ...
      case "contact_deleted": return <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--red)" strokeWidth="2"><circle cx="9" cy="8" r="3.2"/><path d="M3.8 19c0-2.9 2.3-5 5.2-5s5.2 2.1 5.2 5"/><line x1="14" y1="9" x2="20" y2="15"/><line x1="20" y1="9" x2="14" y2="15"/></svg>;
